...
#define DIGIPOT_MOTOR_CURRENT {40,40,20,110} // Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)
...
// Add support for experimental filament exchange support M600; requires display
  ...
  #define FILAMENT_CHANGE_FEATURE             // Enable filament exchange menu and M600 g-code (used for runout sensor too)
    ...
    #define FILAMENT_CHANGE_X_POS 80             // X position of hotend
    #define FILAMENT_CHANGE_Y_POS 168.5             // Y position of hotend
    ...
    #define FILAMENT_CHANGE_UNLOAD_LENGTH 45   // Unload filament length from hotend in mm
                                                // Longer length for bowden printers to unload filament from whole bowden tube,
                                                // shorter lenght for printers without bowden to unload filament from extruder only,
                                                // 0 to disable unloading for manual unloading
    #define FILAMENT_CHANGE_UNLOAD_FEEDRATE 3  // Unload filament feedrate in mm/s - filament unloading can be fast
    ...
    #define FILAMENT_CHANGE_EXTRUDE_LENGTH 45   // Extrude filament length in mm after filament is load over the hotend,
